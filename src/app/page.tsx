...
import { getPrayerTimes, getCurrentPrayer, PrayerTimesType, PrayerInfo, isRamadanToday } from "@/utils/prayerCalculations";
...
import { fetchRamadanData } from "@/utils/ramadanData";
